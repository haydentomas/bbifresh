...
if ( ! function_exists( 'bbifresh_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'bbifresh-styles', get_template_directory_uri() . '/css/styles.css', [], '1.0.4', 'all');

    wp_deregister_style( 'bbifresh-style' );
    wp_enqueue_style( 'bbifresh-style', get_bloginfo('stylesheet_url'), [], '1.0.4', 'all');
